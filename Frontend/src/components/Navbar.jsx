  ...
  return ( 
    <header className='sticky top-0 z-50 bg-white/90 backdrop-blur-md-shadow-sm border-b border-gray-200 font -sans'>
        <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7x1 mx-auto'>
            ...
            {/*RIGHT SIDE*/}
            <button className='p-2 text-gray-600 hover:text-purple-500 transition-colors duration-300 hover:bg-pink-50 rounded-full' onClick={()=> navigate('/')}>
              <Settings className='w-5 height-5'/>
            </button>
            {/* USE DROPDOWN */}
              ...
              {menuOpen &&(
                <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                  <li className='p-2'>
                    ...
                    className='w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-gray-700 trasnsition-colors flex items-center gap-2 group'role='menuitem'>
